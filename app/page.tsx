...
export default function NotionClone() {
  ...
  const events = [
    { id: 1, title: "My first meeting", time: "9 AM", location: "Office", day: "Today", date: "May 6" },
    { id: 2, title: "Lunch", time: "1 PM", location: "Restaurant", day: "Today", date: "May 6" },
    { id: 3, title: "Grocery shopping", time: "11 AM", location: "Store", day: "Wed", date: "May 7" },
    { id: 4, title: "Birthday celebration", time: "7 PM", location: "Restaurant", day: "Wed", date: "May 7" },
  ]
  ...
  return (
    <div className="flex h-screen bg-[#191919] text-white">
      {/* Sidebar */}
      <div
        className={`${sidebarCollapsed ? "w-14" : "w-60"} border-r border-[#333] flex flex-col transition-all duration-200`}
      >
        <div className="p-3 flex items-center justify-between border-b border-[#333]">
          ...
          {!sidebarCollapsed && (
            <button className="text-gray-400 hover:text-white transition" onClick={toggleSidebar}>
              <ChevronLeft className="h-4 w-4" />
            </button>
          )}
          {sidebarCollapsed && (
            <button className="text-gray-400 hover:text-white transition mx-auto" onClick={toggleSidebar}>
        ...
        <div className="p-2 space-y-1">
          <div
            className={`flex items-center gap-2 p-2 rounded-md text-gray-400 hover:bg-[#333] cursor-pointer transition ${searchActive ? "bg-[#333] text-white" : ""}`}
              ...
              <>
                ...
                {searchActive && (
                  <div className="flex-1 flex items-center">
                    ...
                    />
                    {searchQuery && (
                      <button className="text-gray-400 hover:text-white" onClick={clearSearch}>
                        <X className="h-3 w-3" />
                      </button>
                    )}
                  </div>
          ...
          <div
            className={`flex items-center gap-2 p-2 rounded-md hover:bg-[#333] cursor-pointer transition ${activePage === "home" ? "bg-[#333] text-white" : "text-gray-400"}`}
          ...
          <div
            className={`flex items-center gap-2 p-2 rounded-md hover:bg-[#333] cursor-pointer transition ${activePage === "inbox" ? "bg-[#333] text-white" : "text-gray-400"}`}
        ...
        {!sidebarCollapsed && (
          <>
            <div className="mt-4 px-3">
              ...
              >
                <span>Shared</span>
                {sharedExpanded ? <ChevronDown className="h-3 w-3" /> : <ChevronRight className="h-3 w-3" />}
              </div>

              {sharedExpanded && (
                <div className="space-y-1">
                  <div
                    className={`flex items-center gap-2 p-2 rounded-md text-gray-400 text-sm hover:bg-[#333] cursor-pointer transition ${activePage === "schuler-ai" ? "bg-[#333] text-white" : ""}`}
                  ...
                  <div
                    className={`flex items-center gap-2 p-2 rounded-md text-gray-400 text-sm hover:bg-[#333] cursor-pointer transition ${activePage === "plastic-fikirler" ? "bg-[#333] text-white" : ""}`}
            ...
            <div className="mt-4 px-3">
              ...
              {privateExpanded && (
                <div className="space-y-1">
                  <div
                    className={`flex items-center gap-2 p-2 rounded-md text-gray-400 text-sm hover:bg-[#333] cursor-pointer transition ${activePage === "quick-note" ? "bg-[#333] text-white" : ""}`}
                  ...
                  <div
                    className={`flex items-center gap-2 p-2 rounded-md text-gray-400 text-sm hover:bg-[#333] cursor-pointer transition ${activePage === "personal-home" ? "bg-[#333] text-white" : ""}`}
                  ...
                  <div
                    className={`flex items-center gap-2 p-2 rounded-md text-gray-400 text-sm hover:bg-[#333] cursor-pointer transition ${activePage === "reading-list" ? "bg-[#333] text-white" : ""}`}
                  ...
                  <div
                    className={`flex items-center gap-2 p-2 rounded-md text-gray-400 text-sm hover:bg-[#333] cursor-pointer transition ${activePage === "schule" ? "bg-[#333] text-white" : ""}`}
                  ...
                  <div
                    className={`flex items-center gap-2 p-2 rounded-md text-gray-400 text-sm hover:bg-[#333] cursor-pointer transition ${activePage === "startup" ? "bg-[#333] text-white" : ""}`}
        ...
        <div className="mt-auto p-3 border-t border-[#333] flex items-center justify-between">
          <Dialog open={showNewPageModal} onOpenChange={setShowNewPageModal}>
            <DialogTrigger asChild>
              <div
                className={`flex items-center gap-2 text-gray-400 hover:text-white cursor-pointer transition ${sidebarCollapsed ? "justify-center" : ""}`}
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="right" className="bg-[#333] text-white border-[#444]">
                  ...
                  >
                    <div className="flex justify-between mb-4">
                      <div>
                        ...
                        {page.icon === "file" && <FileText className="h-6 w-6 text-gray-400" />}
                        {page.icon === "forum" && (
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-[#333] border-[#444] text-white">
                          <DropdownMenuItem className="hover:bg-[#444] cursor-pointer">Rename</DropdownMenuItem>
                          <DropdownMenuItem className="hover:bg-[#444] cursor-pointer">Duplicate</DropdownMenuItem>
              ...
              <div className="flex flex-col md:flex-row">
                <div className="flex-1 flex items-center justify-center p-6">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm">See your upcoming events and join meetings from Home.</p>
                ...
                <div className="flex-1 border-t md:border-t-0 md:border-l border-[#333] p-4">
                  {events.reduce((acc: JSX.Element[], event, index, array) => {
                    ...
                    if (index === 0 || event.day !== array[index - 1].day) {
                      acc.push(
                        <div key={`day-${event.day}`} className={`${index > 0 ? "mt-6" : ""} mb-4`}>
                          <div className="text-xs text-gray-400 mb-1">{event.day}</div>
      ...
      <div className="fixed bottom-6 right-6">
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent side="left" className="bg-[#333] text-white border-[#444]">
              <p>New page</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
